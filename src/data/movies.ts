...
export const featuredMovie: Movie = movies[1];

export const trending: Movie[] = ['m1', 'm2', 'm5', 'm4', 'm10', 'm3'].map(id => byId[id]);
export const continueWatching: Movie[] = ['m3', 'm8', 'm11', 'm9'].map(id => byId[id]);
export const newReleases: Movie[] = ['m2', 'm1', 'm6', 'm7', 'm12'].map(id => byId[id]);
export const actionMovies: Movie[] = ['m5', 'm6', 'm10', 'm8', 'm9'].map(id => byId[id]);
export const nolanCollection: Movie[] = ['m1', 'm3', 'm4', 'm5'].map(id => byId[id]);

export const rows: MovieRow[] = [
  {id: 'r1', title: 'Trending Now', movies: trending},
  {id: 'r2', title: 'Continue Watching', movies: continueWatching},
  {id: 'r3', title: 'New Releases', movies: newReleases},
  {id: 'r4', title: 'Action & Adventure', movies: actionMovies},
  {id: 'r5', title: 'The Nolan Collection', movies: nolanCollection},
];
